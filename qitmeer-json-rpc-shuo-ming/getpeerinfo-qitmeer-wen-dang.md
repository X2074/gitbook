# getPeerInfo :: Qitmeer 文档

### getPeerInfo <a href="#getpeerinfo" id="getpeerinfo"></a>

#### 函数名：getPeerInfo <a href="#han-shu-ming-getpeerinfo" id="han-shu-ming-getpeerinfo"></a>

#### 说明：无参数，取邻近节点信息 <a href="#shuo-ming-wu-can-shu-qu-lin-jin-jie-dian-xin-xi" id="shuo-ming-wu-can-shu-qu-lin-jin-jie-dian-xin-xi"></a>
