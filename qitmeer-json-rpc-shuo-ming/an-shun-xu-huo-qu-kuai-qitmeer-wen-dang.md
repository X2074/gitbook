...
#### 函数名：getBlockByOrder {order} {verbose} {inclTx} {fullTx} <a href="#han-shu-ming-getblockbyorderorderverboseincltxfulltx" id="han-shu-ming-getblockbyorderorderverboseincltxfulltx"></a>

#### 说明：返回指定Order的Block <a href="#shuo-ming-fan-hui-zhi-ding-order-de-block" id="shuo-ming-fan-hui-zhi-ding-order-de-block"></a>
